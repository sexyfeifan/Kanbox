const CATEGORY_RULES = [
  ...
  },
  {
    category: '影视娱乐',
    strong: [
      /电视剧|综艺|追剧|观影|影评|票房|演员|明星|导演|偶像|动漫|剧情|台词|韩剧|美剧|日剧|国漫|下饭剧|片单|脱口秀|纪录片|电影/i,
    ],
    weak: [/看剧|院线|片荒|老片/i],
    tagBoost: [/电影|电视剧|综艺|追剧|影视|动漫|明星|演员/i],
  },
  {
    category: '情感治愈',
    strong: [
      /情感|恋爱|治愈|心理|情绪|疗愈|心灵|共情|情绪价值|内耗|焦虑|抑郁|正能量|心灵鸡汤|童话|童心|自我关怀|接纳|释怀|孤独|温暖|陪伴/i,
    ],
    weak: [/感受|心态|人生感悟/i],
    tagBoost: [/情感|治愈|心理|疗愈|心灵|童话|童心|正能量/i],
  },
];
