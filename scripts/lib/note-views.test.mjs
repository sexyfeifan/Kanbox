...
const notes = [
  ...
  { id: 'c', title: '已读', savedAt: '2026-08-01T08:00:00+08:00', readState: 'read', lastReadAt: '2026-08-10T08:00:00+08:00' },
];

test('智能视图兼容旧笔记并统计今日、最近阅读和阅读状态', () => {
  const counts = countNoteViews(notes, now);
  assert.deepEqual(counts, { all: 3, favorite: 1, unread: 1, later: 1, read: 1, recent: 1, today: 1 });
